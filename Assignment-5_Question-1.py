# This assignment has 5 questions based on 'GUI' and 'Searching and Sorting'
# Here are the code to these 5 problems

# Question ---> 1
# To make a GUI-based 'GST Tax Finder' calculator
...
if __name__ == "__main__":
    ...
    # Create a Find Button and attached to findGst function
    ...
    # Create a Clear Button and attached to clearAll function
